...
/**
 * Class (strategy) representing condition demanding first value to be smaller or equal to second.
 * @author Teo Toplak
 * 
 */
public class SmallerEqualsCondition implements IComparisonOperator {
