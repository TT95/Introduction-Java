...
/**
 * Class (strategy) representing condition demanding first value to be larger or equal to second.
 * @author Teo Toplak
 * 
 */
public class LargerEqualsCondition implements IComparisonOperator {
