...
/**
 * Class representing AscendingAction.
...
public class AscendingAction extends AbstractAction{
	 ...
	 */
	public AscendingAction(String key, ILocalizationProvider lp,JNotepadPP notepad) {
	...
	public void actionPerformed(ActionEvent e) {
		TextUtility.utility(notepad,(start,length,doc)-> {
			...
			String fin = SortUtility.sort(doc.getText(startLine, endLine-startLine), true);
