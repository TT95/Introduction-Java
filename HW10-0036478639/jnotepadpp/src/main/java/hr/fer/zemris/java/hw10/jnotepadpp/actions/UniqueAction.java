...
/**
 * Class representing UniqueAction.
...
public class UniqueAction extends AbstractAction{
	 ...
	 */
	public UniqueAction(String key, ILocalizationProvider lp,JNotepadPP notepad) {
	...
	public void actionPerformed(ActionEvent e) {
		TextUtility.utility(notepad,(start,length,doc)-> {
			...
			String fin = removeDuplicateLines(doc.getText(startLine, endLine-startLine));
	 ...
	 * @return text with removed duplicated lines
	 */
	private String removeDuplicateLines(String str) {
