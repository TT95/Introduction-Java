...
/**
 * Iznimka koja se baca ako se nad matricom ili vektorom
 * koji je nepromjenjiv (tj. read-only) zatraži provođenje 
 * operacije koja objekt pokušava na bilo koji način 
 * promijeniti.
 * 
 * @author marcupic
 *
...
public class UnmodifiableObjectException extends RuntimeException {
	 ...
	 * Konstruktor.
	 * 
	 * @param cause razlog zbog kojeg je iznimka izazvana
	 * 
