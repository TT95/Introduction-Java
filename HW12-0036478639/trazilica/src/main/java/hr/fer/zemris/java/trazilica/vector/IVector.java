package hr.fer.zemris.java.trazilica.vector;
...
public interface IVector {
	 ...
	 * @return traženu vrijednost ili baca iznimku ako je indeks izvan dozvoljenih granica
	...
	int getDimension();
	/**
	 * Vraća novu kopiju trenutnog vektora koja se može slobodno mijenjati
	 * i koja nije povezana s originalnim vektorom.  Originalni vektor se 
	 * ne mijenja. Najčešće će implementacija metodom {@link #newInstance(int)}
	...
	IVector copy();
	/**
	 * Vraća novi vektor čija je dimenzionalnost jednaka {@code n} (argument metode).
	 ...
	 * ostatak se inicijalizira na vrijednost 0.  Originalni vektor se ne mijenja.
	 * 
	 * @param n željena dimenzionalnost novog vektora 
	 ...
	 * koji će se konkretni razred koristiti za taj novi vektor). Implementacija
	 * vektora koja će se dobiti određena je stvarnom implementacijom primjerka
	 * razreda nad kojim je ova metoda pozvana. Najčešće, implementacija će odlučiti
	 * konstruirati novi vektor jednake implementacije kao što je i sam trenutni vektor,
	 * osim ako se ne radi o kakvom proxyju (u tom slučaju zahtjev se može proslijediti
	 * originalnom objektu na koji Proxy gleda pa će on odlučiti o implementaciji).
	 * 
	 ...
	 * 
	 * @param other vektor za koji se treba uvećati trenutni vektor
	 * @return referencu na trenutni vektor
	...
	/**
	 * Vraća novi vektor koji je jednak trenutnom vektoru uvećanom za predani vektor.
	...
	/**
	 * Vraća novi vektor koji je jednak trenutnom vektoru umanjenom za predani vektor.
	 * Originalni vektor se ne mijenja.
	 * 
	 * @param other vektor za koji se treba umanjiti trenutni vektor
	...
	/**
	 * Trenutni vektor modificira tako što ga skalarno množi sa zadanim skalarom.
	 * 
	...
	/**
	 * Vraća novi vektor koji je jednak trenutnom koji je pomnožen sa
	 * zadanim skalarom. Originalni vektor se ne mijenja.
	 * 
	 * @param byValue vrijednost skalara
	 * @return referencu na novi vektor
	 */
	...
	IVector normalize();
	/**
	 * Metoda vraća novi vektor koji je jednak normaliziranom trenutnom
	 * vektoru. Originalni vektor se ne mijenja.
	 * 
	 * @return referencu na novi vektor
	 */
	IVector nNormalize();
	 ...
	 * 
	 * @param other vektor s kojim se trenutni množi
	 * @return vrijednost skalarnog produkta
	 * @throws IncompatibleOperandException ako predani vektor nije kompatibilan s trenutnim
	 */
	double scalarProduct(IVector other) throws IncompatibleOperandException;
	/**
	 * Metoda vraća novi vektor koji je jednak vektorskom produktu
	 * izmedu trenutnog vektora i zadanog vektora.  Originalni vektor 
	 * se ne mijenja.
	 * 
	 * @param other vektor s kojim se računa vektorski produkt
	 * @return referencu na novi vektor
	...
	/**
	 * Vraća vektor u radom prostoru koji se dobije iz trenutnog ako se
	 * trenutni promatra kao da je u homogenom prostoru. To će biti
	 * vektor za jedan manje dimenzionalnosti od trenutnog kod kojeg su
	 * sve komponente jednake trenutnim podijeljenim sa zadnjom. Ako je
	 * posljednja komponenta nula (pa dijeljenje nije definirano), događa
	 * se iznimka. Originalni vektor se ne mijenja.
	 *  
	 * @return referencu na novi vektor
	 * @throws UnsupportedOperationException ako je posljednja komponenta originalnog 
	 *         vektora jednaka 0.
	 */
